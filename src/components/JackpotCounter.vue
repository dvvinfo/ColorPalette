<template>
  <div
    class="bg-gradient-to-r from-primary/80 to-primary rounded-lg p-4 text-white relative overflow-hidden bg-card-bg"
  >
    <!-- Casino Chips SVG -->
    ...
    <div class="relative z-10">
      <h2 class="text-lg font-bold uppercase mb-1">{{ $t('jackpot.title') }}</h2>
